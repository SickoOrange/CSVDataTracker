...
public class TrendsAnalysisController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        portNameTf.setOnKeyPressed(event -> {
            if (event.getCode() == KeyCode.ENTER) {
                ...
                AsyncTaskContainer<Set<String>, Map<String, BinaryTrend>> binaryTrendsTask = new AsyncTaskContainer<>(ImmutableSet.of(uniqueName), nameList -> {
                    try {
    ...
    private void bindBinaryTrendToChart(LineChart<Number, Number> trendsChart, Map<String, BinaryTrend> binaryTrendMap, String uniqueName) {
